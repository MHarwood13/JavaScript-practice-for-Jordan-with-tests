// You are compiling a price checker for a grocery store. The grocery prices
    // are as follows:
    ...
    // Then, write a function mostExpensiveGroceries(groceriesList) that takes in
    // a 2-dimensional array of grocery items and returns the index of the sub-array
...
// If you see the message "You have scored 0/7 points." then your code is not working correctly.
//  If you see the message "You have scored 7/7 points." then your code is working correctly.
...
module.exports = { mostExpensiveGroceries, costOfGroceries };
