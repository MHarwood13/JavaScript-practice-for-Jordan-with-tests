// Write a function factorsOf(num) that takes in a number as an arg. The method should return
// an array containing all positive numbers that are able to divide into num with no remainder.
